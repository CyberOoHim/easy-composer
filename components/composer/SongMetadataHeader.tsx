...
import { KeySignature, LyricDisplayMode, Song, TimeSignature, InstrumentType, VerseDisplayOption, SheetOrientation, SongLanguage } from '@/types/song';
import {
  AlignLeft,
  ChevronDown,
  Music,
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              {/* Song Primary Language (Default: Taigi) */}
              <div className="sm:col-span-2 bg-zinc-50 dark:bg-zinc-800/50 p-3 rounded-xl border border-zinc-200 dark:border-zinc-700/80">
                <div className="flex items-center justify-between mb-1.5">
                  <label
                    className="flex items-center gap-1.5 text-[11px] font-bold text-zinc-600 dark:text-zinc-300 uppercase tracking-wider"
                  >
                    <Languages className="w-3.5 h-3.5 text-amber-500" />
                    <span>Song Primary Language</span>
                  </label>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                  <button
                    type="button"
                    onClick={() => onUpdateSong({ ...song, language: 'taigi' })}
                  ...
                  <button
                    type="button"
                    onClick={() => onUpdateSong({ ...song, language: 'english' })}
                    className={`px-2.5 py-1.5 rounded-lg border font-bold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                  ...
                  <button
                    type="button"
                    onClick={() => onUpdateSong({ ...song, language: 'mandarin' })}
                    className={`px-2.5 py-1.5 rounded-lg border font-bold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                  ...
                  <button
                    type="button"
                    onClick={() => onUpdateSong({ ...song, language: 'japanese' })}
                    className={`px-2.5 py-1.5 rounded-lg border font-bold transition-all cursor-pointer flex items-center justify-center gap-1 ${
