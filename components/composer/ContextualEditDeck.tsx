        ...
        <div className="p-2 sm:p-3 space-y-2 text-sm w-full max-w-full min-w-0 overflow-hidden">
          ...
          {editTarget === 'measure' && (
            <div className="flex flex-col gap-2.5">
              ...
              {isBatchMode && (
                <div className="flex items-center gap-2 bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/80 rounded-xl px-3 py-2 flex-wrap text-xs font-medium text-indigo-900 dark:text-indigo-200">
