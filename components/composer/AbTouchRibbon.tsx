...
export const AbTouchRibbon: React.FC<AbTouchRibbonProps> = ({
  ...
  return (
    <div
      ...
      className="w-full max-w-5xl pointer-events-auto select-none touch-manipulation animate-in fade-in slide-in-from-bottom-2 duration-150 mb-1 px-1"
    >
      <div
        className={`flex flex-wrap items-center justify-between gap-1.5 p-1.5 sm:p-2 rounded-xl sm:rounded-2xl border shadow-xl ${
          sheetTheme === 'dark'
      ...
      >
        ...
        <div className="flex items-center gap-1 shrink-0">
          <span className="flex items-center gap-1 px-2 py-1 bg-amber-500 text-zinc-950 rounded-lg text-xs font-black shadow-xs">
            <span>A-B</span>
          ...
          <div className="flex items-center bg-zinc-100 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-0.5">
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded text-zinc-700 dark:text-zinc-300 disabled:opacity-30 hover:bg-zinc-200 dark:hover:bg-zinc-700 cursor-pointer touch-manipulation"
              title="Expand Point A left by 1 measure"
              aria-label="Nudge Point A left"
            >
              <ChevronLeft className="w-3.5 h-3.5" />
            </button>
            <span className="text-[10px] font-bold px-1 font-mono text-amber-600 dark:text-amber-400">A</span>
            <button
              type="button"
              onClick={() => handleNudgeStart(1)}
          ...
          <div className="flex items-center bg-zinc-100 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-0.5">
            ...
            <span className="text-[10px] font-bold px-1 font-mono text-amber-600 dark:text-amber-400">B</span>
            <button
              type="button"
              onClick={() => handleNudgeEnd(1)}
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 h-8 sm:h-9 rounded-lg text-xs sm:text-sm font-bold transition-all cursor-pointer touch-manipulation shadow-xs active:scale-95 ${
              isPlayingAb
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2.5 h-8 sm:h-9 rounded-lg text-xs font-bold transition-all cursor-pointer touch-manipulation ${
              isLoopingAb
          ...
          <button
            ...
            type="button"
            onClick={onCopyAb}
            className="flex items-center gap-1 px-2.5 h-8 sm:h-9 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 text-xs font-bold transition-all cursor-pointer touch-manipulation"
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1 px-2.5 h-8 sm:h-9 rounded-lg text-xs font-bold transition-all touch-manipulation ${
            ...
            {showPasteOptions && hasClipboardMeasures && (
              <div
                className={`absolute left-0 bottom-full mb-1.5 w-48 rounded-xl border shadow-xl p-1 z-50 flex flex-col gap-1 ${
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-2 rounded-lg text-left text-xs font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-2 rounded-lg text-left text-xs font-bold hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 cursor-pointer"
                >
          ...
          <button
            ...
            type="button"
            onClick={onDeleteAb}
            className="flex items-center gap-1 px-2.5 h-8 sm:h-9 rounded-lg bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-950/70 text-rose-600 dark:text-rose-400 text-xs font-bold transition-all cursor-pointer touch-manipulation"
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="flex items-center bg-zinc-100 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-0.5">
            <button
              ...
              type="button"
              onClick={onSnapBar}
              className="px-2 h-7 rounded text-[11px] font-bold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-700 cursor-pointer touch-manipulation"
          ...
          <div className="relative">
            <button
              ...
              className={`p-2 h-8 sm:h-9 w-8 sm:w-9 rounded-lg flex items-center justify-center transition-all cursor-pointer touch-manipulation ${
                showMoreMenu
            ...
            {showMoreMenu && (
              <div
                className={`absolute right-0 bottom-full mb-1.5 w-52 rounded-xl border shadow-2xl p-1.5 z-50 flex flex-col gap-1 ${
                  sheetTheme === 'dark' ? 'bg-[#151921] border-zinc-700' : 'bg-white border-zinc-200'
                }`}
              >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 p-2 rounded-lg text-left text-xs font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer"
                >
                  <Copy className="w-3.5 h-3.5 text-amber-500" />
                ...
                {/* Transpose Up / Down */}
                <div className="flex items-center justify-between px-2 py-1.5 rounded-lg bg-zinc-50 dark:bg-zinc-850 text-xs font-bold">
                  <span>Transpose</span>
                  <div className="flex items-center gap-1">
                    <button
                      type="button"
                      onClick={() => onTransposeAb(-1)}
                      className="px-2 py-0.5 rounded bg-zinc-200 dark:bg-zinc-700 hover:bg-amber-500 hover:text-zinc-950 cursor-pointer"
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 p-2 rounded-lg text-left text-xs font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 text-amber-600 dark:text-amber-400 cursor-pointer"
                >
          ...
          <button
            ...
            type="button"
            onClick={onClose}
            className="w-8 sm:w-9 h-8 sm:h-9 flex items-center justify-center rounded-lg text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer touch-manipulation"
